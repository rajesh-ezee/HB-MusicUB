...
from HeartBeat.helper.basic import edit_or_reply, get_text, get_user

from HeartBeat.modules.help import *

OWNER = os.environ.get("OWNER", "GhosttBatt")
BIO = os.environ.get("BIO", "ɪ ᴀᴍ ᴘᴀʀᴛ ᴏғ ʜʙ-ꜰᴀᴍ @HeartBeat_Fam")
