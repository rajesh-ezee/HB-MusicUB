...
from HeartBeat import START_TIME
...
from HeartBeat.modules.bot.inline import get_readable_time
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **𝐒ᴜᴘᴘᴏʀᴛ-𝐂ʜᴀᴛ**: [|| ˹𝐇𝐁-𝐅𝐚𝐦˼ ||](t.me/HeartBeat_Fam)\n"
        f"├• **𝐔ᴘᴅᴀᴛᴇs**: [𝐇𝐞𝐚𝐫𝐭𝐁𝐞𝐚𝐭](t.me/HeartBeat_Offi)\n"
        f"└• **𝐌ᴀsᴛᴇʀ**: [𝗚𝗛𝗢𝗦𝗧-𝗕𝗔𝗧](t.me/GhosttBatt)"        
    )

@Client.on_message(
    filters.command(["alive", "ghostop"], ".") & (filters.me | filters.user(SUDO_USER))
)
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://t.me/HeartBeat_Fam ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://t.me/GhosttBatt")
