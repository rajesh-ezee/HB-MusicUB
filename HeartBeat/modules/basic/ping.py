...
from HeartBeat import StartTime, app, SUDO_USER
from HeartBeat.helper.PyroHelpers import SpeedConvert
...
async def pingme(client: Client, message: Message):
    ...
    try:
       ...
       pass
    await xx.edit("**20% ███ ʜʙ▒▒▒▒▒**")
    await xx.edit("**40% ████ ʜʙ-ꜰᴀ**")
    await xx.edit("**60% ██████ʜʙ-ꜰᴀᴍ**")
    await xx.edit("**80% ████████ ʜᴇᴀʀᴛ**")
    await xx.edit("**100%██████████ʜᴇᴀʀᴛʙᴇᴀᴛ**")
    end = datetime.now()
